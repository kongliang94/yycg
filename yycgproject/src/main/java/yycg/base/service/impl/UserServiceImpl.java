...
public class UserServiceImpl implements UserService{
	...
	public List<SysuserCustom> findSysuserList(SysuserQueryVo sysuserQueryVo)
		...
		return this.sysuserMapperCustom.findSysuserList(sysuserQueryVo);
	}
	@Override
	public int findSysuserCount(SysuserQueryVo sysuserQueryVo) throws Exception {
		return this.sysuserMapperCustom.findSysuserCount(sysuserQueryVo);
	}
	@Override
...
//			throw new ExceptionResultInfo(resultInfo);
		...
		this.sysuserMapper.insert(sysuserCustom);
	}
	@Override
	public void deleteSysuser(String id) throws Exception {
		
		Sysuser sysuser = this.findSysuserByUserid(id);
		if (sysuser!=null) {
			//用户不存在
	...
	@Override
	public List<UseryyCustom> findUseryylist(UseryyQueryVo useryyQueryVo)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public ActiveUser checkUserInfo(String userid, String pwd) throws Exception{
		...
		String page_pwd=new MD5().getMD5ofStr(pwd);
		if (page_pwd!=null&&!page_pwd.equalsIgnoreCase(sysuser.getPwd())) {
